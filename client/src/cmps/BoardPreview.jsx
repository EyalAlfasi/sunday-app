...
export const BoardPreview = (props) => {
    ...
    const onDrag = useSelector(state => state.boardReducer.onDrag)
    const loggedInUser = useSelector(state => state.userReducer.loggedInUser)
    const dispatch = useDispatch()
    // componentDidUpdate(prevProps, prevState) {
    //     if (!prevProps.onDrag && props.onDrag) {
    //         if (state.filterBy) {
    //             const copyFilter = { ...state.filterBy }
    //             copyFilter.sortBy = '';
    //             setState({ filterBy: copyFilter })
    //         }
    //     }
    // }
